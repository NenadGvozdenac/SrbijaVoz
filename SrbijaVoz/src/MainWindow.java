...
public class MainWindow extends JFrame implements ActionListener {
	...
	public void DODAJ_OSTALE_STVARI(JPanel panelCentar, BazaPodataka.Korisnik korisnik) {
		...
		JLabel label1 = new JLabel("<html> - Odlukom Vlade Republike Srbije 05 Broj 023-7361/2015 od 2. jula 2015. godine, osnovano je Akcionarsko dru�tvo za �elezni�ki prevoz putnika �Srbija Voz� Beograd, kao dru�tvo sticalac dela imovine ��eleznice Srbije� a.d. <br><br> - Dru�tvo je upisano u registar Agencije za privredne registre, 10. avgusta 2015. godine, kada je steklo svojstvo pravnog lica i po�elo da posluje.</html>");
